            ...
            <div class="row page-titles mx-0">
                <div class="col-sm-6 p-md-0">
                    <div class="welcome-text">
                        ...
                        <span class="ml-1">Data table potong</span>
                    </div>
                </div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="float-start">
                                <h4 class="card-title">Data potong</h4>
                            </div>
                            <div class="float-end">
                                <a href="{{ route('potong.create') }}" class="btn btn-sm btn-primary">
                                    + Tambah Data
                                </a>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <form>
                                                        @csrf
                                                        @method('DELETE')
                                                        <a href="{{ route('potong.edit', $data->id) }}"
                                                            class="btn btn-sm btn-warning" style="margin-bottom: 2%;">
                                                            Edit
                                                        </a>
                                                        <a href="{{route('potong.destroy',$data->id)}}" class="btn btn-sm btn-danger" 
