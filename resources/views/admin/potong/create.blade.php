                ...
                <div class="card-body">
                    <form action="{{ route('potong.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control @error('nama_pemotong') is-invalid @enderror" name="nama_pemotong"
                            required>
                            @error('nama_pemotong')
                        ...
                        <div class="mb-2">
                            ...
                            <input type="date" class="form-control @error('tanggal_potong') is-invalid @enderror" name="tanggal_potong"
                            required>
